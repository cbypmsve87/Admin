...
CREATE TABLE `fa_menu` (
  ...
  `menu_name` varchar(60) collate utf8_bin default NULL COMMENT '菜单名称',
...
INSERT INTO `fa_menu` VALUES ('qqgl', '权限管理', '0', '1', '2017-12-05', null, 'admin', null, null, 'fa-authority.html', 'fa fa-file-text', null, '5');
